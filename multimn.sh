...
# Author: EVONodesOfficial
# Source: https://github.com/evo-nodes/EVONodes-MultiMN
...
function cmd_bootstrap() {
	...
	#For copied bootstrap data while new node installation // Ex. : multimn install evonodes --bootstrap
...
function cmd_help() {
	echo -e "Options:\
			...
			\n**NOTE 2**: Check ${CYAN}https://github.com/evo-nodes/EVONodes-MultiMN/wiki/Commands${NC} for extended info and usage examples of each command.\
			\n**NOTE 3**: Check ${CYAN}https://github.com/evo-nodes/EVONodes-MultiMN/wiki/FAQs${NC} for technical questions and troubleshooting."
}
function cmd_update() {
	curl -sL https://raw.githubusercontent.com/evo-nodes/EVONodes-MultiMN/main/multimn_install.sh 3>&3 | bash
	exit
}
