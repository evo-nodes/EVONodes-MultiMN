...
echo -e "\n====================================================================================\
         ...
         \n   ${GRAY}██║ ╚═╝ ██║ ╚██████╔╝ ██████╗   ██║    ██████╗ ${NC}██║ ╚═╝ ██║██║ ╚████║  \
         \n   ${GRAY}╚═╝     ╚═╝  ╚═════╝  ╚═════╝   ╚═╝    ╚═════╝ ${NC}╚═╝     ╚═╝╚═╝  ╚═══╝  \
         \n                                ╗ made by ${GREEN}EVONodes${NC} ╔\
         \n                   Credit: ${YELLOW}Credit for this script to neo3587${NC}\
         \n           Source: ${CYAN}https://github.com/evo-nodes/EVONodes-MultiMN${NC}\		 
         \n====================================================================================\
         \n                                                   "

multimn_update=$(curl -s https://raw.githubusercontent.com/evo-nodes/EVONodes-MultiMN/main/multimn.sh)
